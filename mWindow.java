...
class mWindow extends Frame implements WindowListener, MouseListener, MouseMotionListener {
    int x = 0, y = 0;
    Label l;
    ...
    public void print(String s,int x0, int y0){
        strEvent = s;
        x = x0;
        y = y0;
        repaint();
    ...
    public void mouseClicked(MouseEvent e) {
        print("MouseClicked",e.getX(),e.getY());
    }

    public void mousePressed(MouseEvent e) {
        print("MousePressed",e.getX(),e.getY());
    }

    public void mouseReleased(MouseEvent e) {
       print("released",e.getX(),e.getY());
    }

    public void mouseEntered(MouseEvent e) {
        print("entered",e.getX(),e.getY());
    }

    public void mouseExited(MouseEvent e) {
        print("exited",e.getX(),e.getY());
    }
